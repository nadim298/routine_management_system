...
if(isset($_GET['delete_id'])){
    ...
    $delete_query="DELETE FROM `programs` WHERE `programs`.`id` = $delete_id";
    if(mysqli_query($conn,$delete_query)){
        $_SESSION['delmsg']="Program deleted Successfully";
    }
else
    ...
    <div class="page-container container-fluid">
        ...
        <div class="page-content">
            ...
            <div class="panel panel-default">
                <div class="panel-heading"><h6 class="panel-title">Manage Programs</h6>
                        ...
                        <tbody>
                           <?php
                            ...
                            <tr>
                                ...
                                <td>
                                <a href="edit_program.php?edit_id=<?php echo $row['id'];?>" class="btn btn-sm btn-primary">Edit</a>
                                <a href="manage_program.php?delete_id=<?php echo $row['id'];?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this program?');">Delete</a>
                                </td>
                            </tr>
                            <?php
                                    $count++;
