...
if(isset($_GET['delete_id'])){
    ...
    $delete_query="DELETE FROM `batches` WHERE `batches`.`id` = $delete_id";
    if(mysqli_query($conn,$delete_query)){
        $_SESSION['delmsg']="Batch deleted Successfully";
    }
else
    ...
    <div class="page-container container-fluid">
        ...
        <div class="page-content">
            ...
            <div class="panel panel-default">
                <div class="panel-heading"><h6 class="panel-title">Manage Batches</h6>
                        ...
                        <tbody>
                           <?php
                            ...
                            <tr>
                                ...
                                <td><?php echo $row['cr_email'];?></td>
                                <td>
                                <a href="edit_batch.php?edit_id=<?php echo $row['id'];?>" class="btn btn-sm btn-primary">Edit</a>
                                <a href="manage_batch.php?delete_id=<?php echo $row['id'];?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this batch?');">Delete</a>
                                </td>
                            </tr>
                            <?php
                                    $count++;
