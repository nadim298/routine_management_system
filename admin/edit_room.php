...
$query="SELECT * FROM rooms where id=$edit_id";
...
$sql = "UPDATE `rooms` SET `room_no` = '$room_no' WHERE `rooms`.`id` = $edit_id";
if(mysqli_query($conn,$sql)){
                    $_SESSION['updatemsg']="Succesfully Updated Room";
            ...
            <form class="form-horizontal" method="post" style="width: 400px; margin: auto;  " >
              ...
              <br>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="room_no" value="<?php echo $row['room_no'];?>" required="required">
                            </div>
                        </div>                        
