...
if(isset($_GET['delete_id'])){
    ...
    $delete_query="DELETE FROM `faculty` WHERE `faculty`.`id` = $delete_id";
    if(mysqli_query($conn,$delete_query)){
        $_SESSION['delmsg']="Faculty deleted Successfully";
    }
else
    ...
    <div class="page-container container-fluid">
        ...
        <div class="page-content">
            ...
            <div class="panel panel-default">
                <div class="panel-heading"><h6 class="panel-title">Manage Faculty</h6>
                        ...
                        <tbody>
                           <?php
                            ...
                            <tr>
                                ...
                                <td>
                                <a href="edit_faculty.php?edit_id=<?php echo $row['id'];?>" class="btn btn-sm btn-primary">Edit</a>
                                <a href="manage_faculty.php?delete_id=<?php echo $row['id'];?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this faculty?');">Delete</a>
                                </td>
                            </tr>
                            <?php
                                    $count++;
