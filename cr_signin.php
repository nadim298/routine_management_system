<?php
	...
	if(isset($_POST['signin'])){
			...
			$query="SELECT * FROM batches WHERE cr_email='$email' AND password='$password'";
            ...
            if(mysqli_num_rows($run)>0){
				...
				header('location:cr/dashboard.php');
			}
			else{
            ...
            <form class="form-horizontal" method="post" style="width: 400px; margin: auto;  " >
               ...
               <br>
                <div class="panel panel-default">
                    <div class="panel-heading"><h6 class="panel-title">CR Sign In</h6></div>
                    <br>
                    <div class="panel-body">
                        ...
                        <a class="btn pull-right" href="forget_password.php?user=student">Forget Password</a>
                        <br>
                    </div>                    
                </div>
            </form>
